...
<div id="management_index_page">
    ...
    foreach ($pageList as $page) {
        ...
        <div class="management_index_block">
            <?php echo PassionEngine\Engine\Core\CoreHtml::getLink('?module=management&manage=' . $page['value'], '<img alt="" src="' . PassionEngine\Engine\Lib\LibMakeStyle::getTemplateDirectory() . '/management/icon_' . $pictureName . '.png" style="border: 0;" /><div><span class=\"text_bold\">' . $page['name'] . '</span></div>'); ?>
        </div>
        <?php
    }
    ?>

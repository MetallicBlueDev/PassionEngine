    ...
    <body>
        <div id="metallic_blue_sky">
            ...
            <div id="metallic_blue_sky_screen">
                <header id="header">
                    <div style="display: none;"><?php echo PassionEngine\Engine\Core\CoreMain::getInstance()->getConfigs()->getDefaultSiteName(); ?></div>
                    <div id="header_left">
                        ...
                        <a href="index.php" title="<?php echo PassionEngine\Engine\Core\CoreMain::getInstance()->getConfigs()->getDefaultSiteName(); ?>"></a>
                        <h3><?php echo PassionEngine\Engine\Core\CoreMain::getInstance()->getConfigs()->getDefaultSiteSlogan(); ?></h3>
                    </div>
                ...
                <div id="wrapper">
                    <div id="wrapper_leftfix">
                        <div id="wrapper_rightfix">
                            <div id="wrapper_left">
                                <?php echo PassionEngine\Engine\Lib\LibBlock::getInstance()->getBlocksBuildedBySide(PassionEngine\Engine\Core\CoreLayout::BLOCK_SIDE_LEFT); ?>
                            </div>
                            <div id="wrapper_middlefix">
                                <div id="wrapper_middle">
                                    ...
                                    <div>
                                        <?php echo PassionEngine\Engine\Lib\LibBlock::getInstance()->getBlocksBuildedBySide(PassionEngine\Engine\Core\CoreLayout::BLOCK_SIDE_MODULE_TOP); ?>
                                    </div>
                                    <div id="module_top">
                                    ...
                                    <div id="module_content_leftfix">
                                        <div id="module_content_rightfix">
                                            <div id="module_content_middle">
                                                <?php echo PassionEngine\Engine\Core\CoreMain::getInstance()->getRoute()->getRequestedModuleData()->getFinalOutput(); ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <?php echo PassionEngine\Engine\Lib\LibBlock::getInstance()->getBlocksBuildedBySide(PassionEngine\Engine\Core\CoreLayout::BLOCK_SIDE_MODULE_BOTTOM); ?>
                                    </div>
                                    <div>
                                        <?php echo PassionEngine\Engine\Lib\LibBlock::getInstance()->getBlocksBuildedBySide(PassionEngine\Engine\Core\CoreLayout::BLOCK_SIDE_MODULE_RIGHT); ?>
                                    </div>
                                    <?php echo PassionEngine\Engine\Lib\LibBlock::getInstance()->getBlocksBuildedBySide(PassionEngine\Engine\Core\CoreLayout::BLOCK_SIDE_BOTTOM); ?>
                                </div>
                            </div>
                            <div id="wrapper_right_compatibility">
                                ...
                                <div id="wrapper_right">
                                    <?php echo PassionEngine\Engine\Lib\LibBlock::getInstance()->getBlocksBuildedBySide(PassionEngine\Engine\Core\CoreLayout::BLOCK_SIDE_RIGHT); ?>
                                </div>
                            </div>
                        </div>
                    </div>

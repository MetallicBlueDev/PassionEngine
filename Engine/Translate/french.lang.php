...
// Erreur critique généré par CoreSecure
    ...
    "ERROR_DEBUG_SQLCANUSE" => "Le module nécessaire à la communication avec la base de données n'est pas disponible.",
    ...
    "ERROR_DEBUG_CACHECANUSE" => "Le module nécessaire à la communication avec le cache n'est pas disponible.",
    "ERROR_DEBUG_CACHECODE" => "Le code d'un gestionnaire de cache n'est pas utilisable.",
    "ERROR_DEBUG_CACHECONNECT" => "Erreur de connexion au cache.",

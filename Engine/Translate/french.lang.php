...
// Erreur critique généré par CoreSecure
    ...
    "ERROR_CODE_3" => "L'implémentation du gestionnaire de cache n'est pas utilisable.",
    ...
    "ERROR_CODE_13" => "Le gestionnaire de base sélectionné n'est pas encore supporté.",
    "ERROR_CODE_14" => "L'implémentation du gestionnaire de base de données n'est pas utilisable.",
    "ERROR_CODE_15" => "Le block demandé n'a pas été trouvé.",

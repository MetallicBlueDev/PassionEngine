...
// Erreur critique généré par CoreSecure
    "ERROR_CODE_SITECLOSED" => "Le site est actuellement fermé.",
    "ERROR_CODE_NETCONNECT" => "Erreur de connexion lors de la création d'une transcation.",
    "ERROR_CODE_NETSELECT" => "Erreur lors de la sélection du noeud de données pour la transcation.",
    "ERROR_CODE_NETCANUSE" => "Le module nécessaire à la transaction n'est pas disponible.",
    "ERROR_CODE_SQLREQ" => "Une erreur SQL est survenue lors d'une requête.",
    "ERROR_CODE_SQLTYPE" => "Le type de base sélectionné n'est pas encore supporté.",
    "ERROR_CODE_SQLPATH" => "Le fichier de configuration de la base de données est introuvable.",
    "ERROR_CODE_SQLCODE" => "Le code d'une base de données n'est pas utilisable.",
    "ERROR_CODE_CACHEPATH" => "Le fichier de configuration du ftp est introuvable.",
    "ERROR_CODE_CACHETYPE" => "Le type de cache sélectionné n'est pas encore supporté.",
    "ERROR_CODE_CACHECODE" => "Le code d'un gestionnaire de cache n'est pas utilisable.",
    "ERROR_CODE_BADURL" => "Merci d'utiliser l'index du site pour naviguer correctement.",
    "ERROR_CODE_LOADER" => "Une erreur lors du chargement d'un fichier est survenue.",
    "ERROR_CODE_CONFIGPATH" => "Le fichier de configuration du site est introuvable.",
    "ERROR_CODE_MAKESTYLE" => "Une erreur est survenue lors de la lecture d'un template.",
    "ERROR_CODE_MAKESTYLECONFIG" => "La configuration des templates n'est pas valide.",
    "ERROR_CODE_BLOCKSIDE" => "Un block tente de s'afficher dans une position invalide.",
    "ERROR_CODE_ACCESSRANK" => "Un type de droit non reconnu a été détecté.",
    "ERROR_CODE_REQUESTHASH" => "Le type de méthode utlisée pour la requête vers le protocole HTTP n'est pas valide.",
// Erreur diverse

...
class ExecString
{
     ...
     * @var array
     */
    private const SUSPICIOUS_TEXT_LIST = array(
    ...
    /**
     * Transforme une chaîne non-encodée, et la convertit en entitiées unicode &#xxx;
...
//        return $encodedString;
    ...
    /**
     * Ajout du caractère d'échappement dans le texte.
     *
     * @param $text string
     * @return string
     */
    ...
    /**
     * Supprime le caractère d'échappement ajouté dans le texte.
     *
     * @param string $text
     * @return string
     */
    ...
    /**
     * Ajout de caractères de citation pour les valeurs non numérique.
     *
     * @param mixed $data

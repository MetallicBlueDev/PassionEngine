...
// Erreur critique généré par Core_Secure
    ...
    "ERROR_DEBUG_SQLDBSELECT" => "Erreur lors de la sélection de la base de données.",
    "ERROR_DEBUG_SQLTEST" => "Le module nécessaire a la communication avec la base de données n'est pas présent.",

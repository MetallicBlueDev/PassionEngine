...
<div id="management_index_page">
    ...
    foreach ($pageList as $page) {
        $pictureName = is_file(TR_ENGINE_DIR . DIRECTORY_SEPARATOR . "templates" . DIRECTORY_SEPARATOR . "default" . DIRECTORY_SEPARATOR . "management" . DIRECTORY_SEPARATOR . "icon_" . $page['value'] . ".png") ? $page['value'] : "no_picture";
        ?>

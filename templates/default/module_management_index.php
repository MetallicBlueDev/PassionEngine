...
<div id="management_index_page">
    ...
    foreach ($pageList as $page) {
        ...
        <div class="management_index_block">
            <?php echo TREngine\Engine\Core\CoreHtml::getLink('?mod=management&manage=' . $page['value'], '<img alt="" src="templates/default/management/icon_' . $pictureName . '.png" style="border: 0;" /><div><b>' . $page['name'] . '</b></div>'); ?>
        </div>
        <?php
    }
    ?>

...
if (CoreMain::getInstance()->isDefaultLayout()) {
    ...
    <div id="management_bar">
        <div>
            <?php echo TREngine\Engine\Core\CoreHtml::getLink('?mod=management', '<img alt="" src="templatestest/default/management/bar_home.png" />'); ?>
        </div>
        <div>
            <?php echo TREngine\Engine\Core\CoreHtml::getLink('?mod=management&manage=update', '<img alt=""  src="templatestest/default/management/bar_update.png" />'); ?>
        </div>
    ...
    <?php
    include TR_ENGINE_INDEXDIR . DIRECTORY_SEPARATOR . "templatestest" . DIRECTORY_SEPARATOR . "default" . DIRECTORY_SEPARATOR . "module_management_title.php";
}
?>